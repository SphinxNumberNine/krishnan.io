...
import {EmailIcon,FacebookIcon, GithubIcon, InstagramIcon, LinkedinIcon, PhoneIcon, TwitterIcon} from '../../Icon/Icon';
import Section from '../../Layout/Section';
import ContactForm from './ContactForm';

const ContactValueMap: Record<ContactType, ContactValue> = {
  [ContactType.Email]: {Icon: EmailIcon, srLabel: 'Email'},
